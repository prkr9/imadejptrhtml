! function(t) {
    ...
    t.exports = JSON.parse('{"a":"prebid3.23.0.js"}')
}, function(t, n, e) {
    e(69);
    var i = e(30);
    ...
    var s = e(11),
        ...
        I = [{
            ...
            code: "rewarded",
            mediaTypes: [5, 10, 24, 26].includes(T) ? B.mediaTypes : C.mediaTypes,
            bids: x([5, 10, 24, 26].includes(T) ? B.bids : C.bids, [{
                bidder: "rubicon",
                params: {
                    accountId: "18608",
                    siteId: "266916",
    ...
    var rt = e(67),
        ...
        mt = function() {
            function t() {
                var n = this;
                this.autoStartOnReady = !1, this.criteria = {}, this.debugIsOverwritten = !1, this.handlers = {}, this.isInitialized = !1, this.programmaticAdsEnabled = !0, this.sdkBooted = !1, this.sdkImaError = !1, this.startAdEnabled = !1, this.startStartAdsAfterTimerOnInit = !1, this.initOptions = {}, this.debug = !1, this.adReady = !1, this.debugTouchOverlayController = !1, this.setPlayerAge = function(t) {
                    t && function(t, n) {
                        if (H) try {
            ...
            return t.prototype.init = function(t) {
                ...
                var n = this,
                    ...
                    _ = e.forceDisableHB,
                    D = void 0 !== _ && _,
                    O = parseInt(S("site_id"), 10) || 0,
                    j = J(rt.a).then((function() {
                        var t;
                    ...
                    M = ct({}, h);
                i ? (t.isPokiPlatform = !0, M = ct(ct({}, M), {
                    adTagUrl: i,
                    customCriteria: s,
                    adTiming: o
                })) : t.isPokiPlatform = !1;
                ...
                var Z = S("pokiDebug");
                return Z ? (this.setDebug("true" === Z), this.debugIsOverwritten = !0) : this.setDebug(this.debug || u), this.debugTouchOverlayController && (v() || b()) && dt(), Promise.all([R(), it(), J(""), J(""), j]).catch((function() {
                    ...
                    e = function() {
                        ...
                        n.sdkImaError ? l.dispatchEvent(c.ads.displayError, {
                            ...
                            n.googletag.cmd.push((function() {
                                var i, r;
                                null === (i = t.parentElement) || void 0 === i || i.removeAttribute("data-poki-ad-size"), null === (r = t.parentElement) || void 0 === r || r.removeChild(t), n.googletag.destroySlots([e])
                            }))
                        })))
                    };
                this.isInitialized ? e() : this.lazyLoadInit().then(e)
            ...
            function t() {
                ...
                this.gameStarted = !1, this.SDK = new pt, this.init = function(n) {
                    return void 0 === n && (n = {}), new Promise((function(e, i) {
                        n && n.adTagUrl && window && (window.__InternalSDK = t.SDK), t.SDK.init(Tt({
                            onReady: e,
                            onAdblocked: i
                    ...
                    if (g.track(c.tracking.screen.getLeaderboard, {}), t.SDK.debug) {
                        for (var n = [], e = 0; e < 10; e++) n.push({
                            rank: e + 1,
                            score: 1e4 - 1e3 * e,
                            profile: {
                                name: "DummyData" + e,
