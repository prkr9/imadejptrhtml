! function(n) {
    ...
    function a(n, e) {
        if (n.Module) {
            ...
            PokiSDK.gameLoadingProgress(o), e >= 1 && "done" !== f.className && (f.className = "done", document.getElementById("progress-comment").innerHTML = "Preparing game [HAVE FUN]...", document.getElementById("progress-spinner").style.display = "flex", g && clearTimeout(g))
        }
    }
